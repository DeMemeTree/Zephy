import MoneroTxPriority = require("zephyr-javascript/src/main/js/wallet/model/MoneroTxPriority");
import MoneroDestination = require("zephyr-javascript/src/main/js/wallet/model/MoneroDestination");
